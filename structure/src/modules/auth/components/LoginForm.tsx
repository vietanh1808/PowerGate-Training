...
const LoginForm = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="row justify-content-around" style={{ margin: '16px 0' }}>
        ...
        <a className="col-md-auto" href={ROUTES.register} style={{ textDecoration: 'none' }}>
          <FormattedMessage id="Bạn chưa có tài khoản?" />
        </a>
      </div>
    </form>
  );
